...
const drill = {
    name: 'Drill',
    id: 'drill',
    description: 'Drill a human-sized hole in the wall leading straight into the vault.', 
    result: 'Successfully sneak into the vault undetected. Earn 10 clever points, but minus 5 health points for having to re-drill the hole because you didn\'t fit the first time.',
    hp: -5,
    cp: 10
};
